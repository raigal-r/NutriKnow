...
const BarcodeScanner = () => {
  ...
  useEffect(() => {
    if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
      ...
      Quagga.onDetected((data) => {
        ...
        fetchData(`https://world.openfoodfacts.org/api/v0/product/${data.codeResult.code}.json`).then(fetchedData => { 
          // setData(fetchedData)
          console.log(fetchedData.product.nutriments);
        });
  ...
  return (
    <div>
      <div ref={videoRef} /> {/* This div will contain the video stream */}
